...
# negroni = Drink.find_or_initialize_by(
...
# ).save!
# negroni.ingredients.find_or_initialize_by(description: "⅓ oz. Campari").save!
# negroni.ingredients.find_or_initialize_by(description: "⅓ oz. gin").save!
# negroni.ingredients.find_or_initialize_by(description: "⅓ oz. sweet vermouth").save!
# negroni.ingredients.find_or_initialize_by(description: "Chilled prosecco, or other sparkling wine, for topping").save!
# negroni.ingredients.find_or_initialize_by(description: "Orange peel twist (optional)").save!

# margarita = Drink.find_or_initialize_by(
...
#   source: "http://www.architecturaldigest.com/gallery/4-easy-entertaining-summer-cocktail-recipes-5-ingredients-or-less"
# ).save!
# margarita.ingredients.find_or_initialize_by(description: "½ oz. fresh lime juice").save!
# margarita.ingredients.find_or_initialize_by(description: "⅓ of a large jalapeño, sliced, plus more for garnish").save!
# margarita.ingredients.find_or_initialize_by(description: "1¾ oz. tequila").save!
# margarita.ingredients.find_or_initialize_by(description: "1½ oz. fresh pineapple juice").save!
# margarita.ingredients.find_or_initialize_by(description: "½ oz. Grand Marnier or other orange liqueur").save!
# margarita.ingredients.find_or_initialize_by(description: "Coarse salt, for rimming glass").save!
# margarita.ingredients.find_or_initialize_by(description: "Pineapple wedge and peel, for garnish").save!

# Drink.find_or_initialize_by(
